...
EXCEL_CORE_PATH = "endo/data/pulp_v.0.3.1.xlsx"
...
ALLOWED_HOSTS = config('DJANGO_ALLOWED_HOSTS').split(',') # type: ignore
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=10),   # or longer if needed
